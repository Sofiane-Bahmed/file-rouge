...
const NavBar = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-[#F9FFF5] shadow-xl z-40 relative">
      {({ open }) => (
        <>
                ...
                {user ? (
                  <>
                    <Menu as="div" className="relative ml-3">
                      ...
                      >
                        <Menu.Items className="absolute right-0 z-50 mt-2 w-80 origin-top-right rounded-xl bg-white py-2 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
