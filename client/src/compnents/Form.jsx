...
const Form = ({ data, onCancel, refetch }) => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const formData = {
            firstName, lastName, domain, company, experience, about,
            skills, localisation, disponibility, responseTime, price,
        };
        ...
        <div className="bg-white w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl shadow-2xl flex flex-col animate-in fade-in zoom-in duration-300">
            ...
            <form onSubmit={handleFormSubmit} className="flex-1 overflow-y-auto p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Professional */}
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-gray-700 uppercase tracking-wider">Domain / Role</label>
                        <input
                            type="text"
                            value={domain}
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#007749]/20 focus:border-[#007749] outline-none transition-all"
                            placeholder="e.g. Weekends, 6pm - 9pm"
                        />
                    </div>

                    <div className="space-y-2">
                        <label className="text-sm font-bold text-gray-700 uppercase tracking-wider">Price per Month ($)</label>
                        <input
                            type="number"
                            value={price}
                    ...
                    <div className="md:col-span-2 space-y-2">
                        <label className="text-sm font-bold text-gray-700 uppercase tracking-wider">About</label>
                        <textarea
                            value={about}
                            ...
                            placeholder="Describe your professional background and what you offer as a mentor..."
                        />
                    </div>
